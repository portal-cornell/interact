...
if __name__ == "__main__":
    ...
    model.hh.load_state_dict(torch.load(f'./interact/checkpoints/finetuned_HH_checkpoints/{load_model_id}/{30}.model'))
    ...
    directory = f'./interact/checkpoints/trained_HR_checkpoints/{model_id}'
