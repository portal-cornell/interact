combinations=(
    ...
    # "-c --bob-hand" #conditional 2hist hand/wrist
    # "-c" #conditional 2hist alljoints
    "-c --bob-hand --align_rep --align_weight=0.3" #conditional 2hist hand/wrist
    "-c --align_rep --align_weight=0.3" #conditional 2hist alljoints
)

for args in "${combinations[@]}"; do
    # python finetune_intent_forecaster.py --log-dir=./logs_ft_intent_withCMU $args
    python finetune_hr.py  --log-dir=./logs_ft_intent_hr_align_orient2 $args
done
