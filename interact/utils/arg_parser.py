...
def get_parser():
    ...
    parser.add_argument("--log-dir", type=str, help="Logging directory for tensorboard", default='./logs/logs_default')
    ...
    parser.add_argument("--eval-data", type=str, help="Evaluation dataset", default='cmu', choices=['cmu','handover','react_stir','table_set','cabinet','take','cart'])
